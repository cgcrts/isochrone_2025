...
const updateIsochroneIntervalOptions = () => {
    ...
    for (let i = 0; i < 6; i++) {
        if (timeLimitInput.value % (i + 1) == 0) {
            ...
            isochroneIntervalInput.innerHTML += `
                <option value="${value}">${value} minuti, ${i + 1} isocrone${i + 1 > 1 ? "" : ""}</option>
            `;
...
formElem.addEventListener("submit", async (e) => {
    ...
    submitButton.innerHTML = `<img src="./assets/images/target.png" width="20" height="20"> Annullare`;
    ...
    try {
        ...
        submitButton.innerHTML = `<img src="./assets/images/target.png" width="20" height="20"> Calcolare`;
